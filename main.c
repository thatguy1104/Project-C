...
void fmatrix(char matrix[ITERATIONS][5], int count) {//print matrix
    char matfinal[ITERATIONS][5];
    int i, j;
    char continuekey[2];
    printf("\nPress any key to show the bidimensional array\n");
    fgets(continuekey, 2, stdin); //print matrix
    for (i = 0; i < count; i++) {
        for (j = 0; j < 5; j++) {
...
void numreps(int count, char matfinal[ITERATIONS][5]) {//see if any string repeats within big matrix ---mat[count][5]
...
void repetitions(int count) {//counts how many times a character or number is repeated in the whole matrix. (fmatrix printed)
    ...
    for (i = 0; i <= count; i++) {
        ...
        for (j = 0; j < 5; j++) {
            ...
            switch (mat[i][j]) {
                case '0':
                    num_of_reps[0] = num_of_reps[0] + 1;
                    break;
                case '1':
                    num_of_reps[1] = num_of_reps[1] + 1;
                    break;
                case '2':
                    num_of_reps[2] = num_of_reps[2] + 1;
                    break;
                case '3':
                    num_of_reps[3] = num_of_reps[3] + 1;
                    break;
                case '4':
                    num_of_reps[4] = num_of_reps[4] + 1;
                    break;
                case '5':
                    num_of_reps[5] = num_of_reps[5] + 1;
                    break;
                case '6':
                    num_of_reps[6] = num_of_reps[6] + 1;
                    break;
                case '7':
                    num_of_reps[7] = num_of_reps[7] + 1;
                    break;
                case '8':
                    num_of_reps[8] = num_of_reps[8] + 1;
                    break;
                case '9':
                    num_of_reps[9] = num_of_reps[9] + 1;
                    break;
                case 'A':
                    num_of_reps[10] = num_of_reps[10] + 1;
                    break;
                case 'B':
                    num_of_reps[11] = num_of_reps[11] + 1;
                    break;
                case 'C':
                    num_of_reps[12] = num_of_reps[12] + 1;
                    break;
                case 'D':
                    num_of_reps[13] = num_of_reps[13] + 1;
                    break;
                case 'E':
                    num_of_reps[14] = num_of_reps[14] + 1;
                    break;
                case 'F':
                    num_of_reps[15] = num_of_reps[15] + 1;
                    break;
                case 'G':
                    num_of_reps[16] = num_of_reps[16] + 1;
                    break;
            }
        }
    }
